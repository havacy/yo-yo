...
class Aimbot:
    ...
    def __init__(self, box_constant = box_size, collect_data = False, mouse_delay = 0.0001, debug = False):
       ...
       # else:
        ...
        self.model.iou = 0.25 # NMS IoU (0-1)
    ...
    def is_target_locked(x, y):
        ...
        threshold = 0
        return True if 720 - threshold <= x <= 720 + threshold and 540 - threshold <= y <= 540 + threshold else False   
    ...
    def interpolate_coordinates_from_center(absolute_coordinates, scale):
        diff_x = (absolute_coordinates[0] - 720) * scale/Aimbot.pixel_increment
